...
(define (<spectrum-file>-write buffer object)
  (write-object buffer (spectrum-file-path object))
  (write-object buffer (spectrum-file-station object))
  (write-object buffer (spectrum-file-year object))
  (write-object buffer (spectrum-file-variable object)))

(define (<spectrum-file>-read buffer object)
  (set! (spectrum-file-path object) (read-object buffer))
  (set! (spectrum-file-station object) (read-object buffer))
  (set! (spectrum-file-year object) (read-object buffer))
  (set! (spectrum-file-variable object) (read-object buffer)))
