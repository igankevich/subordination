#ifndef BSCHEDULER_KERNEL_KERNEL_INSTANCE_REGISTRY_HH
#define BSCHEDULER_KERNEL_KERNEL_INSTANCE_REGISTRY_HH
...
namespace bsc {
	...
	typedef kernel_instance_registry<BSCHEDULER_KERNEL_TYPE> instance_registry_type;
